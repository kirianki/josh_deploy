    ...
    <div className="container mx-auto p-4">
      ...
      <Card className="mb-8">
        ...
        <CardContent className="p-6">
          <p className="text-lg mb-4">{professional.bio}</p>
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="flex items-center">
              ...
              <span>Education: {professional.education}</span>
            </div>
            <div className="flex items-center">
              <Award className="mr-2 h-4 w-4 text-gray-500" />
              <span>Skills: {professional.skills.join(', ')}</span>
            </div>
            <div className="flex items-center">
              <Linkedin className="mr-2 h-4 w-4 text-gray-500" />
              <a href={professional.linkedin} target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline">LinkedIn Profile</a>
            </div>
          </div>
        </CardContent>
      </Card>
